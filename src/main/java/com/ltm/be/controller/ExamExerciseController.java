...
@RestController
@RequestMapping("/api/exercise-exam")
@RequiredArgsConstructor
@Tag(name = "Exercise exam Controller")
public class ExamExerciseController {
    private final IExamExerciseService exerciseExamService;

    @PostMapping("/add-all")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseData<?> addExercisesToExam(@Valid @RequestBody ExamExerciseRequest request) {
    ...
    public ResponseData<?> getAddedExercisesByexamId(@RequestParam Long examId,
